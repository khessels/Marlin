...
#define STRING_CONFIG_H_AUTHOR "Kees Hessels" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3D & Laser Printer"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 480, 440 }
